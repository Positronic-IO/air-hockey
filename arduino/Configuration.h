...
#define TABLE_LENGTH 860.425
#define TABLE_WIDTH 482.6
...
#define ROBOT_MAX_Y ROBOT_CENTER_Y-60
...
#define ROBOT_INITIAL_POSITION_Y 58   // Measured from center of the robot pusher to the table border
